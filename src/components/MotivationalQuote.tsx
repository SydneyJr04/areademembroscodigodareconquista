...
export const MotivationalQuote = () => {
  ...
  return (
    <div className="mb-8 rounded-lg border border-primary/30 bg-gradient-to-r from-primary/20 via-secondary/20 to-primary/20 p-6">
      <div className="flex items-start gap-3">
        <Sparkles className="mt-1 h-6 w-6 flex-shrink-0 text-primary" />
        <p className="text-lg font-medium italic text-foreground">{randomQuote}</p>
      </div>
    </div>
  );
};
